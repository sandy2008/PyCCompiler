            ...
            if func_name == 'printf':
                ...
                for parameter in parameter_list[::-1]:
                    ...
                    if self.symbol_table[parameter]['type'] == 'STRING_CONSTANT':
                        ...
                        if field_type == 'int':
                            ...
                            print
                            'field type except int and float is not supported yet!'
                            exit()
                    else:
                        print
                        'parameter type not supported in printf yet!'
                        exit()
                line = 'call printf'
                self.ass_file_handler.insert(line, 'TEXT')
                ...
                for parameter in parameter_list[::-1]:
                    ...
                    if parameter_type == 'STRING_CONSTANT' or parameter_type == 'VARIABLE':
                        ...
                        print
                        'parameter type not supported in scanf!'
                        exit()
                line = 'call scanf'
                self.ass_file_handler.insert(line, 'TEXT')
                line = 'add $' + str(num * 4) + ', %esp'
        ...
        def _assignment(self, node=None):
            ...
            if current_node.type == 'IDENTIFIER' and current_node.right.value == 'Expression':
                ...
                if field_type == 'int':
                    ...
                    print
                    'field type except int and float not supported!'
                    exit()
            else:
                print
                'assignment wrong.'
        ...
        def _handler_block(self, node=None):
            ...
            if node.value in self.sentence_type:
                ...
                # return语句
                    ...
                    print
                    'sentenct type not supported yet！'
                    exit()
